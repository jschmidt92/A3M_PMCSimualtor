...
A3M_svr_TRKEscort = {
    ...
    A3M_fnc_DelDestinationTrigger = {
        ...
        DelDest setTriggerStatements ["DEL1 in thisList", "remoteExecCall ['A3M_svr_ConvoySuccess', 2];", ""];
    };
...
A3M_svr_SandE = {
    ...
    RescueAction = SAR1 addAction ["Rescue" , {
        ...
        remoteExec ["A3M_MP_ChangeSARDest"];
    }];
...
A3M_svr_Raid1 = {
    ...
    Raid1Win setTriggerStatements ["this", "remoteExecCall ['A3M_svr_RaidClear', 2];", ""];
};
...
A3M_svr_Raid2 = {
    ...
    Raid2Win setTriggerStatements ["this", "remoteExecCall ['A3M_svr_RaidClear', 2];", ""];
};

A3M_svr_RaidClear = {
    // [ '','A3M_MP_RaidClear',true,false] spawn BIS_fnc_MP;
    remoteExec ["A3M_MP_RaidClear"];
...
A3M_svr_T9sec = {
    ...
    T9trg setTriggerStatements ["this", "remoteExecCall ['A3M_MP_T9Shift']; remoteExecCall ['A3M_fnc_SelectIncident', 2];", ""];
};
...
A3M_fnc_ProtestTrg = {
    ...
    T9ProsTrg setTriggerStatements ["ProtestLeader in thisList", "remoteExecCall ['A3M_MP_T9ProtestChant'];", 'ProtestActive = 0; publicVariable "ProtestActive";'];
};
...
A3M_fnc_AttackT9 = {
    ...
    T9wpE1 setTriggerStatements ["({ alive _x } count units T9EF) < 1", "remoteExecCall ['A3M_MP_T9EnemyElim'];", ""];
};
...
A3M_fnc_dblAttackT9 = {
    ...
    T9wpE2 setTriggerStatements ["({ alive _x } count units T9EF2) < 1", "remoteExecCall ['A3M_MP_T9EnemyElim'];", ""];
    ...
    T9wpE3 setTriggerStatements ["({ alive _x } count units T9EF3) < 1", "remoteExecCall ['A3M_MP_T9EnemyElim'];", ""];
};
...
A3M_fnc_Delivery = {
    ...
    T9wpT2 setTriggerStatements ["T9DelTrk in thisList", "remoteExecCall ['A3M_MP_T9TrkInPos'];", ""];
    ...
    T9wpT3 setTriggerStatements ["T9DelTrk in thisList", "remoteExecCall ['A3M_MP_T9TrkDelIP'];", ""];
    ...
    remoteExecCall ["A3M_MP_T9TrkDelIP2"];
    ...
    T9wpT4 setTriggerStatements ["T9DelTrk in thisList", "remoteExecCall ['A3M_MP_T9TrkDelCplt'];", ""];
...
A3M_svr_SpeechWinTrigger = {
    ...
    RTBtrg setTriggerStatements ["SpeechVIP in thisList", "remoteExecCall ['A3M_svr_SpeechMissionComplete', 2];", ""];
};
...
A3M_svr_PresenceDetector = {
    ...
    PDtrg setTriggerStatements ["thie", "[] spawn A3M_fnc_PresenceDetector", ""];
};

A3M_fnc_PresenceDetector = {
    // ["","A3M_MP_SpeechSetup1",true,false] call BIS_fnc_MP;
    remoteExecCall ["A3M_MP_SpeechSetup1"];
    sleep 60;
    // ["","A3M_MP_SpeechSetup2",true,false] call BIS_fnc_MP;
    remoteExecCall ["A3M_MP_SpeechSetup2"];
    sleep 60;
    // ["","A3M_MP_SpeechSetup3",true,false] call BIS_fnc_MP;
    remoteExecCall ["A3M_MP_SpeechSetup3"];
    SpeechScene = 1;
...
A3M_fnc_VIPLifeMon = {
    ...
    remoteExecCall ["A3M_svr_DignitaryKilled", 2];
};
...
A3M_svr_DgntrySec = {
    ...
    switch (SpeechPos) do {
        case "SpeechPos1": {
            ...
            remoteExecCall ["A3M_MP_HandleSpeech"];
            ...
            if (SniperSel == 1) then {
                ...
                SniperEsc setTriggerStatements ["RSniper in thisList;", "remoteExecCall ['A3M_svr_SniperEscaped', 2];", ""];
            };
            ...
            if (SpeechInterrupt == 0) then {
                ...
                remoteExecCall ["A3M_MP_SpeechExTask"];
...
A3M_svr_SniperEscaped = {
    ...
    remoteExecCall ["A3M_MP_SniperEsc"];
...
A3M_svr_DignitaryKilled = {
    ...
    remoteExecCall ["A3M_MP_DVSTaskFailed"];
    // ["", "A3M_MP_CrowdPanic",true,false] call BIS_fnc_MP;
    remoteExecCall ["A3M_MP_CrowdPanic"];
...
A3M_svr_SpeechMissionComplete = {
    ...
    switch (SpeechInterrupt) do {
        ...
        case 1: {
            ...
            remoteExecCall ["A3M_MP_SpeechMissionComplete"];
        };
