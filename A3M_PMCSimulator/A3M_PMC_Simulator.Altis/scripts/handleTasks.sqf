...
A3M_fnc_Email = {
    ...
    switch (TheSelection) do {
        case 0: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M1.paa"; };
        case 1: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M2.paa"; };
        case 2: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M3.paa"; };
        case 3: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M4.paa"; };
        case 4: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M5.paa"; };
        case 5: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M6.paa"; };
        case 6: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M7.paa"; };
        case 7: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M8.paa"; };
        case 8: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M9.paa"; };
        case 9: { ((findDisplay 1420) displayCtrl 1200) ctrlSetText "images\M10.paa"; };
    };
};

A3M_fnc_AcceptMission = {
    switch (TheSelection) do {
        case 0: { [] spawn A3M_msn_VIPEscort; };
        case 1: { [] spawn A3M_msn_TRKEscort; };
        // case 2: { ["","A3M_msn_chkpt",true,false] call BIS_fnc_MP; };
        case 2: { remoteExecCall ["A3M_msn_chkpt", 0, true]; };
        case 3: { [] spawn A3M_msn_SandE; };
        case 4: { [] spawn A3M_msn_Raid1; };
        case 5: { [] spawn A3M_msn_Raid2; };
        case 6: { [] spawn A3M_msn_reinforce; };
        case 7: { [] spawn A3M_msn_T9sec; };
        case 8: { [] spawn A3M_msn_Hden1; };
        case 9: { [] spawn A3M_msn_DgntrySec; };
        default {};
    };
};
// EOF
