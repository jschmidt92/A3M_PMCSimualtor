...
Rifle Range Lane B V1.0 by Cody Salazar AKA Fr33d0m
www.A3MilSim.com
...
M4RRTarget addEventHandler ["hitPart", {
    ...
    M4RR_B_Totalhits = M4RR_B_Totalhits + 1;

    publicVariable "M4RR_B_Totalhits";

    _monitor = format ["Hit! \n Shooter: %1 \n Damage / Round Type: %2 \n Direct Hit: %3 \n Total Hits This Round: %4", GunrShooter, GunrDamage, GunrDirectHit, M4RR_B_Totalhits];
    hint _monitor;
}];
