...
A3M_fnc_SARSuccess = {
    ...
    remoteExecCall ["A3M_MP_SARSuccess"];
...
A3M_fncNSARFailed = {
    ...
    remoteExecCall ["A3M_MP_SARfailed"];
...
A3M_fnc_SARfound = {
    ...
    remoteExecCall ["A3M_MP_SARfound"];
    ...
    NSARdest2 setTriggerStatements ["NSARlead in thislist", "remoteExecCall ['A3M_fnc_SARSuccess', 2];", ""];
};
...
remoteExecCall ["A3M_MP_StartTaskNSAR"];
