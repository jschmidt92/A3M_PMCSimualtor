...
switch (MissionStatus) do {
    ...
    case "M9": {
        ...
        hint "A security force is currently working a raid on a hacker den. Contact your team coordinator for information and possible assignment on this objective.";
    };
    case "M10": {
    ...
    default { hint "Something went horribly wrong. Could not assign JIP task"; };
};
