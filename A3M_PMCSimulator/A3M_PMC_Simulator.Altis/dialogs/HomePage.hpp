...
class A3M_HomePage {
    ...
    class Controls {
        ...
        class A3M_Btn_PBank: RscClrButton {
            onButtonClick = "[] call A3M_fnc_AccessBank";
            idc = 2150;
        ...
        class A3M_Btn_Fleet: RscClrButton {
            onButtonClick = "execVM 'scripts\FleetMgmt.sqf'";
            idc = 2200;
        ...
        class A3M_Btn_Arms: RscClrButton {
            onButtonClick = "execVM 'scripts\ItemStore.sqf'";
            idc = 2250;
            x = 0.567331 * safezoneW + safezoneX;
        ...
        class A3M_Btn_Admin: RscClrButton {
            onButtonClick = "[] spawn A3M_fnc_AdminPanel";
            idc = 2300;
        ...
        class A3M_Btn_Mail: RscClrButton {
            onButtonClick = "execVM 'scripts\handleTasks.sqf'";
            idc = 2350;
