...
class A3M_store {
    ...
    class Controls {
        ...
        class A3M_SelectArmor: RscButton {
            onButtonClick = "[] call DoAddArmored";
            idc = 1605;
        ...
        class A3M_RotaryVeh: RscButton {
            onButtonClick = "[] call DoAddRotary";
            idc = 1606;
        ...
        class A3M_SelectPlanes: RscButton {
            onButtonClick = "[] call DoAddFixedWing";
            idc = 1607;
        ...
        class A3M_Btn_Prch: RscButton {
            onButtonClick = "[] call A3M_fnc_VBuyButton";
            idc = 1601;
        ...
        class A3M_Btn_Robotics: RscButton {
            onButtonClick = "[] call DoAddRobotics";
            idc = 1602;
        ...
        class A3M_Btn_Sprt: RscButton {
            onButtonClick = "[] call DoAddSupport";
            idc = 1603;
        ...
        class A3M_Btn_Upgrades: RscButton {
            onButtonClick = "[] call DoAddUpgrades";
            idc = 1608;
